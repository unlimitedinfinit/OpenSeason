...
| Timeline / parties / complaint sections | **Partial** | Standard cases store parties and timeline on `case.json`. Confidential vaults still have SQLite tables for hunt-era data. The UI is one party editor and one dashboard. |
